...
searched= superFrame.getItemList();
  ...
  //create two button
    ...
    Object[][] dataTeacher = new Object[Item.getAllTeachers().size()][columnsTeacher.length];
    Object[][] dataAllTeacher = new Object[Item.getAllTeachers().size()][columnsTeacher.length];
    System.out.println(123);
    //put data in to the varible
    for (int i = 0; i < Item.getAllTeachers().size(); i++) {
      dataTeacher[i][0] = Item.getAllTeachers().get(i);
    }
    for (int i = 0; i < Item.getAllTeachers().size(); i++) {
    ...
    //add button/textfield to the teacherLaout, and add teacherLayout to teacherPage
    ...
    //add the teacher tap to the the mainpanel
     programTab.addTab("Search", searchPanel);
     programTab.addTab("Inventory", inventoryPanel);
 ...
 ///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  public class MyTableModel extends DefaultTableModel {
    ...
    public MyTableModel(Object[][] tableData, Object[] colNames) {
      super(tableData, colNames);  //call super constructor
    }
  ...
  * updates the info for the selected item takks input from
 ...
 public class EditButtonListener implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
   ...
   if (!quantityTF.getText().equals("")) {
    ...
    } catch (Exception E) { // if letters were entered
  ...
  public void actionPerformed(ActionEvent arg0) {
   ...
   if (selection == 1) {
    ...
    if (input != null) {
     ...
     // for (int i = 0; i < superFrame.getItemList().size(); i++) {
     //// superFrame.getItemList().get(i).signBack((String) signIn[index]);
     // }
    ...
    // with the list of teachers from
 ...
 public class DeleteButtonListener implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
   if (searchTextField.getText().equals("")) { // if search is empty
    superFrame.getItemList().remove(searchTable.getSelectedRow()); // remove that index
   } else { // if something is search(original table isn not being displayed) (affecs
      // selected row)
    String name = "";
    name = searchTextField.getText();
    for (int i = 0; i <= superFrame.getItemList().size() - 1; i++) { // runs through arrayLIst
     if (superFrame.getItemList().get(i).getEquipmentName().equals(name)) { // looks for the name
      superFrame.getItemList().remove(i); // removes
     }
    }
   }
   updateTables(); // refreshes
   saveToFile(superFrame.getItemList());// saves to file
  }
 }
 ...
 public void saveToFile(ArrayList<Item> itemList) {
  ...
  try {
   ...
   for (int i = 0; i <= superFrame.getItemList().size() - 1; i++) { //runs through itemlist
  ...
  try {
   ...
   output.close();
   System.out.println("updatedddddddd all teachers");
  ...
  try {
   ...
   output.close();
   System.out.println("updatedddddddd science teachers");
  } catch (IOException error) {
  ...
  try {
   ...
   for (int i = 0; i <= superFrame.getItemList().size() - 1; i++) { // runs through items
    for (int j = 0; j <= superFrame.getItemList().get(i).getSignOutName().size(); j++) { // runs through
                          // number
                          // teachers who
                          // signed it out
     output.print(superFrame.getItemList().get(i).getSignOutName().get(j) + "#"); // puts name + #
    }
 ...
 /**
  ...
  public class MyMouseListener extends MouseAdapter {
    public void mouseClicked(final MouseEvent e) {
      ...
      //if left mouse clicked, then run
 ...
 public class DropDownListener implements ActionListener {
  ...
  public void actionPerformed(ActionEvent e) {
   ...
   if (searched.get(searchTable.getSelectedRow()).getSignOutName().size() > 0) {
    ...
    for (int i = 0; i<= searched.size()-1;i++)
     System.out.println("searched: " +  searched.get(i).getEquipmentName());
  ...
  public class deleteTeacherButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      //if it is from the AllTeacherInSchool table, then delete data from that table, else delete from another table
      if(selected==1){
  ...
  public class addTeacherButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      if(!textField.getText().isEmpty()){
        ...
        //if the data is in allTeacherInSchool, then add t to teacher in department, else add it to allTeacherInSchool
        if (Item.getAllTeachers().contains(textField.getText())) {
          if(!Item.getAllTeachers().contains(textField.getText())) {
