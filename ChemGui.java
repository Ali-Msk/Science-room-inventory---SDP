...
public class ChemGui extends JFrame {
  ...
  ChemGui() throws Exception {
    ...
    teacherSearch = new Object[teachers.size()];
    //teachers = Item.getSignOutName();
    //teacherSearch = teachers.toArray();
  ...
  public class infoButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      ...
      teachers = Item.getSignOutName();
      teacherSearch = teachers.toArray();
      teacherSearchCB.setSelectedItem(teacherSearch);
      */
    }
  ...
  public class takeButtonListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent arg0) {
      ...
      if (selection == 1) {
        ...
        if (signIn.length >=2) {
          input = (String) JOptionPane.showInputDialog(null, "Select your name and it will sign in all of your equipment.", "Equipment Inventory", JOptionPane.INFORMATION_MESSAGE, null, signIn, signIn[1]);
          ...
          input = (String) JOptionPane.showInputDialog(null, "Select your name and it will sign in all of your equipment.", "Equipment Inventory", JOptionPane.INFORMATION_MESSAGE, null, signIn, signIn[0]);
          System.out.println(input);
          if (input == null) {
        ...
        if (result == JOptionPane.OK_OPTION) {
          ...
          Item.signOutTeacher((String) signOut[teacherNames.getSelectedIndex()], Integer.parseInt(amount.getText()));
        }
