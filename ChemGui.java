...
public class ChemGui extends JFrame {
 ...
 private  String[] teacherSearch = { "A", "B", "C", "D", "E", "F" };// should be replaced with the list of teachers from the array
  ...
  ChemGui( ScienceLauncher superFrame) throws Exception {
    ...
    teacherPageGridLayout =  new JPanel(new BorderLayout());
    ...
    teacherPageGridLayout.setBackground(new Color(255, 255, 208)); //colour
    ...
    teacherPageGridLayout.add(teacherLayout,BorderLayout.SOUTH);
    //
    ////////////////////////////////////////////
    ...
    ////////////////////////////////////////////
    teacherPanel.add(teacherPageGridLayout,BorderLayout.SOUTH);
