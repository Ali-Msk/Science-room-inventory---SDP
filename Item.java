...
public class Item {
  // create varible
  private static ArrayList<String> teachersNames = new ArrayList<String>();
  private static int numberInStock;
  private int totalAmountItemInOneLocation;
  private int roomNumber;
  private static int numLeft; // amount left (not signed out)
  private String location;
  private String equipmentName;
  private static HashMap<String, Integer> signOut = new HashMap<String, Integer>();
  private static ArrayList<String> signOutName;
  ...
  public static void signOutTeacher(String teacherName, int numberOfItemSignOut) {
    signOutName.add(teacherName);
    numLeft -= numberOfItemSignOut;
  ...
  // method for signBack
  public static void signBack(String teacherName) {
    numLeft += signOut.get(teacherName); // updates amount left
