...
public class ScienceLauncher {
  ...
  public static void main(String[] args) {
    ...
    /*
     * Scanner input = new Scanner (System.in); ArrayList<Item> searched;
     * System.out.println("search for?"); String searchFor =
     * input.nextLine();
     * 
     * searched = search(searchFor, itemList); for (int i = 0; i<=
     * searched.size()-1;i++){
     * System.out.println(searched.get(i).getEquipmentName()); }
     * 
     * input.close();
     */
    itemList.get(0).signOutTeacher("GHoli", 3);
    itemList.get(0).signOutTeacher("Mr. J", 3);
    itemList.get(0).signBack("GHoli");
    itemList.get(0).signOutTeacher("Mr", 3);
    itemList.get(0).signOutTeacher("MS Hi", 10);
